...
if ($id <= 0) {
    $_SESSION['message'] = "ID de service invalide";
    $_SESSION['message_type'] = 'error';
    header('Location: index.php');
    exit;
}
...
<div class="container">
    ...
    <div class="card">
        <div class="info-box">
            ...
            <span class="label">Service #<?php echo $service->getId(); ?></span>
        ...
        <form method="POST">
            <div class="form-group">
                ...
                <input type="text" name="designation" class="form-control <?php echo $error ? 'error' : ''; ?>" 
                       value="<?php echo htmlspecialchars($service->getDesignation()); ?>" 
            ...
            <div class="form-group">
                ...
                <textarea name="description" class="form-control" 
                          placeholder="Décrivez brièvement ce service..."><?php echo htmlspecialchars($service->getDescription()); ?></textarea>
            </div>

            <div style="padding:12px;background:#f8f9fa;border-radius:6px;margin-bottom:16px;font-size:13px;color:#6b7280;">
                <i class="fas fa-calendar-alt"></i> 
                Service créé le : <?php echo date('d/m/Y H:i'); ?>
            </div>
