...
if (!$avance->isEnCours()) {
    $_SESSION['message'] = "Cette avance n'est pas en cours.";
    $_SESSION['message_type'] = 'error';
    header('Location: index.php');
    exit;
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['confirm'])) {
    if ($avance->marquerRembourse()) {
        $_SESSION['message'] = "Avance sur salaire marquée comme remboursée avec succès !";
        $_SESSION['message_type'] = 'success';
        header('Location: index.php');
        exit;
    } else {
        $_SESSION['message'] = "Erreur lors du remboursement de l'avance.";
        $_SESSION['message_type'] = 'error';
        header('Location: index.php');
        exit;
    }
...
<head>
    ...
    <title>Rembourser l'Avance</title>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .avance-details .value.highlight { font-weight: bold; color: #16a34a; }
...
<div class="container">
    ...
    <div class="card">
        ...
        <p>Vous êtes sur le point de marquer cette avance sur salaire comme <strong>remboursée</strong>.</p>
        ...
        <div class="avance-details">
            ...
            <div class="detail-row">
                ...
                <span class="value"><span class="badge badge-yellow">En cours</span></span>
            </div>
        </div>

        <p style="color:#16a34a;font-weight:bold;">
            <i class="fas fa-info-circle"></i> La date de remboursement sera enregistrée automatiquement.
        </p>

        <form method="POST" action="">
            <div class="btn-group">
                <button type="submit" name="confirm" class="btn btn-success">
                    <i class="fas fa-check-circle"></i> Confirmer le remboursement
                </button>
                <a href="index.php" class="btn btn-secondary">
