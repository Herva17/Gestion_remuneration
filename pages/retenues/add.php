...
<div class="container">
        ...
        <form method="POST">
            ...
            <div class="form-group">
                ...
                <textarea name="description" id="description" class="form-control" rows="3" 
                          placeholder="Description détaillée (facultatif)"><?php echo $retenue ? htmlspecialchars($retenue->getDescription()) : ''; ?></textarea>
            </div>
            ...
            <div style="display:flex;gap:12px;flex-wrap:wrap;">
                ...
                <a href="delete.php?id=<?php echo $retenue->getId(); ?>" class="btn btn-danger" 
                   onclick="return confirm('Êtes-vous sûr de vouloir supprimer cette retenue ?')">
    ...
    <div class="footer">
        &copy; <?php echo date('Y'); ?> - Gestion des Rémunérations
    </div>
</div>
